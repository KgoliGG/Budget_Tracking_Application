...
import com.example.budgettrackingapplication.composable.components.chartsui.chartUIcomponents.line.LineChart
import com.example.budgettrackingapplication.composable.components.chartsui.line.LineChartDataModel.PointDrawerType
  ...
  Row(
    ...
    Row(
      ...
      PointDrawerType.values().forEach { type ->
        OutlinedButton(
          border = ButtonDefaults.outlinedButtonBorder.takeIf { selectedType == type },
